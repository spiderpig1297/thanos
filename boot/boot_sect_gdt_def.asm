...
; segment register. 
; Accessing the first GDT entry will cause a CPU exception.
gdt_null:
    dq 0x0  ; dq - define quadword (8 bytes)
...
gdt_end:    ; Label is used for the assembler to be able to calculate the gdt size.
